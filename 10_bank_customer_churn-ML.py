#!/usr/bin/env python
# Created by "Thieu" at 5:09 PM, 14/10/2024 -------%                                                                               
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

from data.data_loader import load_bank_customer_churn
...
## Load data object
data, scaler_X, scaler_y = load_bank_customer_churn(f"data/{dataset_name}.csv", scaling_method="standard")
#### (10000, 12) x 2 labels (churn : 0, 1)

classifiers = {
    "SVM": SVC(kernel="rbf", C=4, random_state=42),
    "KNN": KNeighborsClassifier(n_neighbors=25),
    "DT": DecisionTreeClassifier(max_depth=20, random_state=42),
    "RF": RandomForestClassifier(max_depth=20, n_estimators=50, max_features=12, random_state=42),
    "ABC": AdaBoostClassifier(n_estimators=50, learning_rate=0.35, random_state=42),
    "GBC": GradientBoostingClassifier(n_estimators=50, learning_rate=0.35, max_depth=20, random_state=42),
    "MLP": MLPClassifier(alpha=1, max_iter=1000, hidden_layer_sizes=(30, ), activation="relu", random_state=42),
