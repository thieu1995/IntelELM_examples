#!/usr/bin/env python
# Created by "Thieu" at 4:31 PM, 14/10/2024 -------%                                                                               
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

from data.data_loader import load_loan_approval
...
## Load data object
data, scaler_X, scaler_y = load_loan_approval(f"data/{dataset_name}.csv", scaling_method="standard")
#### (32581, 12) x 2 labels (0, 1)

classifiers = {
    "SVM": SVC(kernel="rbf", C=2.5, random_state=42),
    "KNN": KNeighborsClassifier(n_neighbors=10),
    "DT": DecisionTreeClassifier(max_depth=8, random_state=42),
    "RF": RandomForestClassifier(max_depth=8, n_estimators=100, max_features=5, random_state=42),
    "ABC": AdaBoostClassifier(n_estimators=100, learning_rate=0.25, random_state=42),
    "GBC": GradientBoostingClassifier(n_estimators=100, learning_rate=0.25, max_depth=5, random_state=42),
