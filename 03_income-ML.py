#!/usr/bin/env python
# Created by "Thieu" at 4:17 PM, 14/10/2024 -------%                                                                               
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

from data.data_loader import load_income
...
## Load data object
data, scaler_X, scaler_y = load_income(f"data/{dataset_name}.csv", scaling_method="standard")
#### 32561 rows × 15 columns x 2 labels (0, 1)

classifiers = {
    "SVM": SVC(kernel="rbf", C=10, random_state=42),
    "KNN": KNeighborsClassifier(n_neighbors=50),
    "DT": DecisionTreeClassifier(max_depth=10, random_state=42),
    "RF": RandomForestClassifier(max_depth=10, n_estimators=200, max_features=5, random_state=42),
    "ABC": AdaBoostClassifier(n_estimators=200, learning_rate=0.5, random_state=42),
    "GBC": GradientBoostingClassifier(n_estimators=200, learning_rate=0.5, max_depth=5, random_state=42),
    "MLP": MLPClassifier(alpha=1, max_iter=1000, hidden_layer_sizes=(50, 25), activation="relu", random_state=42),
    "ELM": ElmClassifier(layer_sizes=(100, 50, 15), act_name="elu")
}
