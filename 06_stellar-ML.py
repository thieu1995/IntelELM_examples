#!/usr/bin/env python
# Created by "Thieu" at 4:48 PM, 14/10/2024 -------%                                                                               
...
classifiers = {
    ...
    "RF": RandomForestClassifier(max_depth=15, n_estimators=250, max_features=10, random_state=42),
    "ABC": AdaBoostClassifier(n_estimators=250, learning_rate=0.5, random_state=42),
    "GBC": GradientBoostingClassifier(n_estimators=250, learning_rate=0.5, max_depth=10, random_state=42),
    "MLP": MLPClassifier(alpha=1, max_iter=1000, hidden_layer_sizes=(30, 15), activation="relu", random_state=42),
    "ELM": ElmClassifier(layer_sizes=(100, 50), act_name="elu")
}
