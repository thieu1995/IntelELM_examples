#!/usr/bin/env python
# Created by "Thieu" at 4:37 PM, 14/10/2024 -------%                                                                               
#       Email: nguyenthieu2102@gmail.com            %                                                    
#       Github: https://github.com/thieu1995        %                         
# --------------------------------------------------%

from data.data_loader import load_stroke_prediction
...
## Load data object
data, scaler_X, scaler_y = load_stroke_prediction(f"data/{dataset_name}.csv", scaling_method="standard")
#### (5110, 12) x 2 labels (0, 1)

classifiers = {
    "SVM": SVC(kernel="linear", C=0.5, random_state=42),
    "KNN": KNeighborsClassifier(n_neighbors=5),
    "DT": DecisionTreeClassifier(max_depth=5, random_state=42),
    "RF": RandomForestClassifier(max_depth=5, n_estimators=40, max_features=5, random_state=42),
    "ABC": AdaBoostClassifier(n_estimators=40, learning_rate=0.2, random_state=42),
    "GBC": GradientBoostingClassifier(n_estimators=40, learning_rate=0.2, max_depth=5, random_state=42),
    "MLP": MLPClassifier(alpha=1, max_iter=1000, hidden_layer_sizes=(25,), activation="relu", random_state=42),
